#!/usr/bin/env python3
"""
Fetch all stocks with a fair value estimate from the Morningstar screener API,
compute potential upside, and output the Top 100.
"""
...
def main():
    ...
    # Output the Top 100
    print(f"\n{'='*80}")
    print(f"  Potential upside Top 100")
    print(f"{'='*80}\n")
    print(f"  {'Rank':>4} {'Ticker':<8} {'Company':<35} {'Price':>10} {'Fair value':>10} {'Upside':>8} {'Stars':>4} {'Moat':<8} {'Industry':<20}")
